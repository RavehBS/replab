...
def main():
    ...
    parser.add_argument('--cameraA', type=str,
                        help='Specify device/path to use for camera A', default='/dev/video1')
    ...
    cameraA.open(args.cameraA)
    assert cameraA.read()[0], 'Camera A returned None, check that the device/path is correct and that the camera is connected'
